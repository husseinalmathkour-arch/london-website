...
export default function WhatsAppButton() {
  ...
  const waLink = `https://wa.me/${mainBranch?.whatsapp ?? ''}?text=Merhaba%2C%20London%20Language%20Academy%20hakkında%20bilgi%20almak%20istiyorum.`
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-72 overflow-hidden border border-gray-100">
          ...
          <div className="flex items-center justify-between px-4 py-3" style={{ backgroundColor: '#25D366' }}>
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-white font-semibold text-sm">London Language Academy</p>
                <p className="text-white/80 text-xs">Genellikle dakikalar içinde yanıt verir</p>
              </div>
            </div>
